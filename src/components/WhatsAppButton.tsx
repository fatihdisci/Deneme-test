...
export const WhatsAppButton = () => {
    ...
    const phoneNumber = "905077247735"; // User Provided Number
    const message = "Merhaba, hukuki danışmanlık almak istiyorum.";

    useEffect(() => {
        // Show button after 1 second delay for a smooth entrance
    ...
    return (
        ...
        >
            ...
            <a
                ...
                className="group relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-2xl hover:bg-[#20bd5a] transition-all duration-300 hover:scale-110"
